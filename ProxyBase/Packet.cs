...
namespace ProxyBase
{
    public abstract class Packet
    {
        ...
        public sbyte ReadSByte()
        {
            ...
            {
                return (sbyte)bodyData[position++];
            }
            throw new IndexOutOfRangeException();
        }
        ...
        {
            return string.Format("{0:X2} {1}", Opcode, BitConverter.ToString(bodyData).Replace('-', ' '));
        }

        public string ToASCII()
        {
            return Encoding.GetEncoding(949).GetString(bodyData);
        }
    }
    ...
    public class ClientPacket : Packet
    {
        ...
        public override void Encrypt(Client client)
        {
            ...
            byte[] bytesToHash = new byte[length + 2];
        ...
        public void EncryptDialog()
        {
            ...
            byte x_prime = (byte)(bodyData[0] - 0x2D);
            byte x = (byte)(bodyData[1] ^ x_prime);
            byte y = (byte)(x + 0x72);
            byte z = (byte)(x + 0x28);
            bodyData[2] ^= y;
